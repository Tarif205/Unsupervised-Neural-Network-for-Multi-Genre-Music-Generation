...
SEQ_LEN         = 500    # frames per window (= 5 seconds at 100 fps)
...
STRIDE          = 800    # set to 250 for 50% overlap
SAVE_DTYPE = "float16"  # "float32" for max precision, "float16" to save disk space (may cause issues on some platforms)    
...
# ── Generation ────────────────────────────────────────────────
MIDI_THRESHOLD  = 0.15   # minimum activation to count as note-on
